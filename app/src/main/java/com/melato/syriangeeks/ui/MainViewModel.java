...
public class MainViewModel extends ViewModel {
    ...
    public void getMyProfile(Context context) {
        setProgressRun("");
        Resources resources = context.getResources();
        ClientAPI.getClientAPI().getMyProfile().enqueue(new Callback<ResponseBodyModel>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBodyModel> call, @NonNull Response<ResponseBodyModel> response) {
                if (response.code() == ClientAPI.OK) {
                    assert response.body() != null;
                    setProgressOK(response.body().getMessage());
                    DashbordModel dashbordModel = new Gson().fromJson(response.body().getData().getAsJsonObject(), DashbordModel.class);
                    dashbordModelLiveData.setValue(dashbordModel);
                } else {
                    setProgressDeny(ClientAPI.parseError(response).getMessage());
                }
            }
    ...
    public void getPublicProfile(Context context,Integer user_id) {
        setProgressRun("");
        Resources resources = context.getResources();
        ClientAPI.getClientAPI().getPublicProfile(user_id).enqueue(new Callback<ResponseBodyModel>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBodyModel> call, @NonNull Response<ResponseBodyModel> response) {
                if (response.code() == ClientAPI.OK) {
                    assert response.body() != null;
    ...
    public void contact(Context context,String name, String email, String phone, String subject, String message) {
        setProgressRun("");
        Resources resources = context.getResources();
        ClientAPI.getClientAPI().contact(name,email,phone,subject,message).enqueue(new Callback<ResponseBodyModel>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBodyModel> call, @NonNull Response<ResponseBodyModel> response) {
                if (response.code() == ClientAPI.OK) {
                    assert response.body() != null;
    ...
    public void mentoringNew(Context context,Integer mentor_id, String title, String phone, String mentoring_date, String content) {
        setProgressRun("");
        Resources resources = context.getResources();
        ClientAPI.getClientAPI().mentoringNew(mentor_id,title,phone,mentoring_date,content).enqueue(new Callback<ResponseBodyModel>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBodyModel> call, @NonNull Response<ResponseBodyModel> response) {
                if (response.code() == ClientAPI.OK) {
                    assert response.body() != null;
